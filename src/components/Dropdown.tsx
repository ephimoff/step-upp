...
const Dropdown = ({ options, selected, setSelected }: DropdownProps) => {
  return (
    <Listbox value={selected} onChange={setSelected}>
      <Listbox.Button className="relative w-full max-w-xs cursor-pointer rounded border-2 border-white bg-white py-1.5 pl-3 pr-10 text-left shadow-md dark:border-slate-800 dark:bg-slate-800 sm:text-sm">
